...
class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            msg =  f'decreased {self.before}->{self.after}' if self.after < self.before else f'increased {self.before}->{self.after}'
...
class Coin:
    ...
    def worth(self):
        ...
        return self.cents + (diff_years - 50) if diff_years > 50 else self.cents
